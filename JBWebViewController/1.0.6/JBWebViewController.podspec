...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ...
                   DESC
  s.homepage     = "https://github.com/seespace/JBWebViewController"
  s.screenshots  = "https://raw.githubusercontent.com/seespace/JBWebViewController/master/Example/screenshot.png"
  s.license      = "MIT"
  s.license      = { :type => "MIT", :file => "LICENSE" }
  s.author             = { "Jonas Boserup" => "jonas@iboserup.dk" }
  s.social_media_url   = "http://twitter.com/JonasBoserup"
  s.platform     = :ios, "7.0"
  s.source       = { :git => "https://github.com/seespace/JBWebViewController.git", :tag => "#{s.version}" }
